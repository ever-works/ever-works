...
- Zero runtime deps beyond `@ever-works/plugin` + Node `crypto`.
- Outbound uses Basic auth (`api:<key>`) and form-encoded bodies; metadata is forwarded as Mailgun `v:` custom variables.
