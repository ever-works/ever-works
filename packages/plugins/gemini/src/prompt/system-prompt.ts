...
/**
 * Default template for the Gemini CLI system prompt.
...
/**
 * Build the system prompt appended to Gemini CLI's built-in system prompt.
...
/**
 * Default template for the Gemini CLI user prompt.
