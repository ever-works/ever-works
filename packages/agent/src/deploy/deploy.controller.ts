        ...
        await this.vercelService.deploy(
            {
                ...
                provider: 'vercel',
                data: {
                    vercelToken: vercelToken || config.vercel.getToken(), // TODO: change it before going to prod
                    ghToken: ghToken || config.github.getApiKey(), // TODO: change it before going to prod
                },
            },
            directory,
            user,
