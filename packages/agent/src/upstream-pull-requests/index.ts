 ...
 *   Also exported: the store token (`UPSTREAM_CREDENTIAL_STORE`, bound by
 *   APW-02's upstream state module), the record/pause/resolution shapes its
 *   callers read, `UPSTREAM_CREDENTIAL_PAUSE_REASONS` with its
 ...
 * service and its pause semantics are complete and tested on their own.
 */
