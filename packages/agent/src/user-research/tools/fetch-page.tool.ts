...
/**
 * Page-fetch tool. Calls the content extractor facade, truncates the result
 * to ~2k chars (model context hygiene), and respects the daily fetch cap.
 * Returns extracted content as plain text/markdown, or an error string.
 */
