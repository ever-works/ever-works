...
/**
 * Stores per-directory custom prompts that are appended to the standard
 * hardcoded prompts during the directory generation workflow.
 *
...
export class DirectoryAdvancedPrompts {
     ...
     * Affects which web pages are considered relevant to the directory topic.
     */
