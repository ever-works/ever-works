...
describe('AnalyticsService', () => {
    ...
    it('should track API usage', () => {
        ...
        expect(spy).toHaveBeenCalledWith('user123', 'api_usage', expect.objectContaining({
            endpoint: '/api/test',
            method: 'GET',
            statusCode: 200,
            duration: 100,
    ...
    it('should track auth events', () => {
        ...
        expect(spy).toHaveBeenCalledWith('user123', 'auth_login', expect.objectContaining({
            provider: 'google',
        }));
    });
    ...
    it('should track business events', () => {
        ...
        expect(spy).toHaveBeenCalledWith('user123', 'business_purchase', expect.objectContaining({
            amount: 100,
        }));
    });
});
