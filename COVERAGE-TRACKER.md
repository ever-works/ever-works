...
- [ ] `works/*` (largest surface — split by sub-module)
  ...
  - [ ] `works/works.controller.ts` (1716 lines — split by endpoint group: CRUD, generation, items, categories/tags, collections, import, scheduled updates, community PR, cancellation). _Largest remaining surface in apps/api/._
