...
- [ ] `integrations/github-app` (large; existing partial coverage — `github-app.service.spec.ts`, `github-app-onboarding.service.spec.ts`, `github-app-sync.service.spec.ts` already shipped, controllers + module test pending)
