...
- Check more detailed information about licensing in our [Wiki](https://github.com/ever-works/ever-works/wiki/Licensing).
- You can also ask any questions in the [Issue](https://github.com/ever-works/ever-works/issues/TODO) or [Contact Us](https://github.com/ever-works/ever-works#contact-us).
...
We support the open-source community. If you're building awesome non-profit/open-source projects, we're happy to help and will provide (subject to [acceptance criteria](https://github.com/ever-co/ever-gauzy/wiki/Free-license-and-hosting-for-Non-profit-and-Open-Source-projects)) Ever Works Enterprise edition license and free hosting option! Feel free to contact us at <mailto:ever@ever.co> to make a request. More details are explained in our [Wiki](https://github.com/ever-co/ever-gauzy/wiki/Free-license-and-hosting-for-Non-profit-and-Open-Source-projects).

**The default Ever Works™ Platform license, without a valid Ever Works™ Platform Small Business or Ever Works™ Platform Enterprise License agreement, is the Ever Works™ Platform Community Edition License.**

### _Ever Works Platform Community Edition_ License

Ever Works™ Platform Community Edition available at https://github.com/ever-works/ever-works released under [GNU Affero General Public License v3.0](https://www.gnu.org/licenses/agpl-3.0.txt).

If you decide to choose the Ever Works™ Platform Community Edition License, you must comply with the following terms:
...
Feel free to [Contact Us](https://github.com/ever-works/ever-works#contact-us) for additional information about used open-source licenses!

### _Ever Works Platform Small Business_ License

Ever Works™ Platform Small Business License can be purchased by small businesses with annual revenues that do not exceed \$1 million and used for single owned Company.
For more information, please see https://ever.works/pricing or contact us at <mailto:ever@ever.works>.

### _Ever Works Platform Enterprise_ License

Ever Works™ Platform Enterprise License can be purchased by businesses with more than \$1 million in annual revenue and used for an unlimited amount of owned companies.
For more information, please see https://ever.works/pricing or contact us at <mailto:ever@ever.works>.
...
**Ever Works**™ is a trademark of [Ever Co. LTD](https://ever.co).
**Ever® Works Platform™**, **Ever® Works Platform Community™**, **Ever® Works Platform Small Business™** and **Ever® Works Platform Enterprise™** are all trademarks of [Ever Co. LTD](https://ever.co).
