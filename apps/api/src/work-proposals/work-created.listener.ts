...
/**
 * EW-584 Phase C — learning loop. When a Work is created, fold its
 * category/tag signals into the creator's inferred profile so future
 * proposal-generation runs are richer.
 *
 * Failure is non-blocking — Work creation always succeeds.
 */
@Injectable()
