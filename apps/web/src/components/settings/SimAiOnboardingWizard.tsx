...
interface SimAiOnboardingWizardProps {
    pluginId: string;
...
export function SimAiOnboardingWizard({
    pluginId,
    visibleProperties,
    getFieldValue,
    handleFieldChange,
    ...
    validationError,
    saveMessage,
}: SimAiOnboardingWizardProps) {
    const t = useTranslations('onboarding.simWizard');
                    ...
                    <div className="space-y-4">
                        ...
                        {baseUrlSchema && (
                            <PluginSettingsField
                                ...
                                value={getFieldValue('baseUrl', baseUrlSchema)}
                                onChange={(value) => handleFieldChange('baseUrl', value, false)}
                                pluginId={pluginId}
                            />
                        )}
                    </div>
