...
const providerIcons: Record<OAuthProvider, ComponentType<{ className?: string }>> = {
    [OAuthProvider.GOOGLE]: GoogleIcon,
    [OAuthProvider.GITHUB]: GitHubIcon,
    [OAuthProvider.FACEBOOK]: FacebookIcon,
    [OAuthProvider.LINKEDIN]: LinkedInIcon,
};
...
export function SocialLoginButtons({ providers }: SocialLoginButtonsProps) {
    ...
    const providerLabels: Record<OAuthProvider, string> = {
        [OAuthProvider.GOOGLE]: t('socialLogin.google'),
        [OAuthProvider.GITHUB]: t('socialLogin.github'),
    ...
    return (
        <div className={cn('grid gap-3', isSingleProvider ? 'grid-cols-1' : 'grid-cols-2')}>
