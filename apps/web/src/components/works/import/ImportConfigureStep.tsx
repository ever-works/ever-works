...
export function ImportConfigureStep({
    ...
    // Load form schema when pipeline changes (same pattern as WorkAICreator)
    useEffect(() => {
        ...
        <div className="space-y-6">
            ...
            {analysisResult?.slugConflict?.hasConflict && (
                <SlugConflictWarning
                    ...
                    onAcceptSuggestion={(name) => onWorkNameChange(name)}
                />
            )}
            ...
            <div className="flex gap-3">
                ...
                <Button
                    ...
                    disabled={isPending || !workName.trim() || !effectiveSourceType}
                    loading={isPending}
                    variant="primary"
                    size="lg"
                    fullWidth
