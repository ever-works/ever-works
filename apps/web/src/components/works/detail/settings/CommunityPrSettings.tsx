...
import { updateCommunityPrSettings } from '@/app/actions/dashboard/works';
...
export function CommunityPrSettings() {
    ...
    const handleToggleEnabled = async (enabled: boolean) => {
        ...
        try {
            const result = await updateCommunityPrSettings(work.id, {
            ...
            <div className="px-5 py-4 space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Switch
                            checked={work.communityPrEnabled}
                ...
                {work.communityPrEnabled && (
                    <div className="flex items-center justify-between pt-2 border-t border-card-border dark:border-border-secondary-dark">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Switch
                                checked={work.communityPrAutoClose}
