...
import { getAdvancedPrompts, updateAdvancedPrompts } from '@/app/actions/dashboard/works';
import { WorkAdvancedPrompts } from '@/lib/api/work';
import {
...
export function AdvancedPromptsSettings({ workId }: AdvancedPromptsSettingsProps) {
    ...
    const loadStandardPrompts = async () => {
        ...
        try {
            const result = await getAdvancedPrompts(workId);

            if (result.success && result.data) {
                const data = result.data as WorkAdvancedPrompts;
                setFormData({
    ...
    const loadComparisonPrompt = async () => {
        ...
        try {
            const comparisonConfig = await getComparisonAiConfig(workId);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const result = await updateAdvancedPrompts(workId, dataToSave);
