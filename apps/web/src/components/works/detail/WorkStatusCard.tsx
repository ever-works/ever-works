...
export function WorkStatusCard({ work }: WorkStatusCardProps) {
    ...
    const currentWork = syncedWork.id === work.id ? syncedWork : work;
                ...
                action: (
                    <div>
                        ...
                        <div className="flex gap-2">
                            <Button
                                href={`${ROUTES.DASHBOARD_WORK(currentWork.id)}/items`}
                                variant="secondary"
                                size="sm"
                            >
