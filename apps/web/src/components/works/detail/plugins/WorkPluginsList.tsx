...
export function WorkPluginsList({
    ...
    const pluginsByCapability = useMemo(() => {
        return capabilities.reduce<Record<string, WorkPlugin[]>>((acc, capability) => {
