...
trigger={(ref, props) => (
            ...
            popupClassName="w-64"
        >
            <div className="rounded-lg bg-card dark:bg-zinc-950 border border-white/10 shadow-xl p-1">
                {/* Title row */}
                ...
                <div className="px-3 py-2 flex flex-col gap-1.5">
                    <p className="text-[11px] leading-relaxed text-text-secondary dark:text-zinc-400">
                        {detail}
                    </p>
                    {checkedAt && (
                        <div className="flex items-center gap-1.5 text-[10px] text-text-muted dark:text-zinc-500">
