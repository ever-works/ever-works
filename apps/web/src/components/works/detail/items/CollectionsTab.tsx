...
export function CollectionsTab({
    ...
    const handleDelete = async (collection: Collection) => {
        ...
        try {
            const result = await deleteCollection(workId, collection.id);
            if (result.success) {
    ...
    const handleSave = async (data: Partial<Collection>) => {
        try {
            if (editingCollection) {
                const result = await updateCollection(workId, editingCollection.id, data);
                ...
                const result = await createCollection(workId, data);
                if (result.success && result.collection) {
