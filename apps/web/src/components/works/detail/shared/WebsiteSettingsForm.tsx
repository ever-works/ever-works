...
import { getWebsiteSettings } from '@/app/actions/dashboard/works';
...
export function useWebsiteSettingsForm(workId: string, loadErrorMessage: string) {
    ...
    const loadSettings = useCallback(async () => {
        setIsLoading(true);
        try {
            const result = await getWebsiteSettings(workId);
    ...
    return (
        <div className="space-y-4">
            ...
            <SettingsCard title={tSettings('sections.global.title')}>
                <div className="grid grid-cols-2 @md/main:grid-cols-4 gap-4">
                    <Switch
            ...
            <SettingsCard title={tSettings('sections.header.title')}>
                <div className="space-y-4">
                    <div className="grid grid-cols-2 @md/main:grid-cols-3 @xl/main:grid-cols-5 gap-4">
                        <Switch
                    ...
                    <div className="grid grid-cols-1 @md/main:grid-cols-3 gap-4 pt-3 border-t border-card-border dark:border-border-secondary-dark">
            ...
            <SettingsCard title={tSettings('sections.footer.title')}>
                <div className="grid grid-cols-2 @md/main:grid-cols-3 gap-4">
                    <Switch
...
function SettingsCard({
    ...
    return (
        <div
            className={cn(
                'rounded-lg border overflow-hidden bg-card dark:bg-card-primary-dark/30 border-card-border dark:border-border-secondary-dark',
                className,
            )}
        >
