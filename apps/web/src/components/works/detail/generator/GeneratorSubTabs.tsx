...
export function GeneratorSubTabs({ workId }: GeneratorSubTabsProps) {
    ...
    const generatorBase = ROUTES.DASHBOARD_WORK_GENERATOR(workId);
    ...
    const tabs = [
        ...
        {
            name: t('schedule'),
            href: ROUTES.DASHBOARD_WORK_SCHEDULE(workId),
            icon: CalendarClock,
        ...
        {
            name: t('history'),
            href: ROUTES.DASHBOARD_WORK_HISTORY(workId),
            icon: History,
            isActive: pathname.includes('/generator/history'),
        },
        {
            name: t('comparisons'),
            href: ROUTES.DASHBOARD_WORK_COMPARISONS(workId),
