			...
			<div className="hidden lg:flex flex-1 bg-surface items-center justify-center px-8 relative overflow-hidden">
				...
				<div className="relative z-10 max-w-lg -mt-24">
					<div className="mb-8">
						...
						<h2 className="text-2xl font-bold text-text mb-4">Build Directories with AI</h2>
						<p className="text-text-secondary mb-8">
							Create beautiful, searchable directories in minutes using natural language. No coding
							required.
						</p>
					</div>
					...
					<div className="space-y-4">
						...
						<div className="flex items-start gap-3">
							...
							<div>
								<h3 className="font-medium text-text mb-1">Professional Templates</h3>
								<p className="text-sm text-text-secondary">
