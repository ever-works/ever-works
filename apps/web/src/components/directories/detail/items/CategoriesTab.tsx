...
export function CategoriesTab({
    ...
    const handleDelete = async (category: Category) => {
        ...
        try {
            const result = await deleteCategory(directoryId, category.id);
            if (result.success) {
    ...
    const handleSave = async (data: Partial<Category>) => {
        try {
            if (editingCategory) {
                ...
                const result = await updateCategory(directoryId, editingCategory.id, data);
                ...
                // Create new category
                const result = await createCategory(directoryId, data);
                if (result.success && result.category) {
