        ...
        <div className="space-y-4">
            ...
            <SettingsCard title={tSettings('sections.header.title')}>
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-3 border-t border-card-border dark:border-border-secondary-dark">
            ...
            <SettingsCard title={tSettings('sections.homepage.title')}>
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3 border-t border-card-border dark:border-border-secondary-dark">
                        <div className="space-y-1.5">
                            <label className="text-xs font-medium text-text-muted dark:text-text-muted-dark">
