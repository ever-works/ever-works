                        ...
                        <div className="relative">
                            ...
                            {notificationsOpen && (
                                <div className={cn(
                                    ...
                                    <div className="p-4">
                                        <p className="text-sm text-text-muted dark:text-text-muted-dark">No new notifications</p>
                                    </div>
                                </div>
                            )}
                        </div>

                        <button className="p-2 rounded-md text-text-secondary dark:text-text-secondary-dark hover:text-text dark:hover:text-text-dark hover:bg-surface dark:hover:bg-surface-secondary-dark">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
