...
export function DashboardSidebar({ user, isOpen, onToggle }: DashboardSidebarProps) {
    ...
    const navigation = [
        ...
        { name: 'Directories', href: '/dashboard/directories', icon: FolderIcon },
        ...
        <aside className={cn(
            ...
            <div className={cn(
                ...
                <div className="flex items-center justify-between w-full">
                    <h1 className="text-xl font-semibold text-text dark:text-text-dark">Ever Works</h1>
                    <button 
                        onClick={onToggle}
                        className={cn(
                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-medium text-text dark:text-text-dark">{user.username}</p>
