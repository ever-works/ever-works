...
- **showComponent** — bespoke canvas components: \`progress\` (percent bars), \`gauge\` (one big % dial, e.g. budget usage), \`timeline\` (event history), \`comparison\` (side-by-side). Pass data you already gathered.
