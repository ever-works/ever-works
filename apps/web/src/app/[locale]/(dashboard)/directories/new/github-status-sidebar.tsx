        ...
        <aside className="w-80 flex-shrink-0">
            <div className={cn(
                ...
                <div className="flex items-center gap-3 mb-4">
                    <svg className="w-8 h-8 text-text dark:text-text-dark" fill="currentColor" viewBox="0 0 24 24">
                ...
                {githubConnected ? (
                    <div className="space-y-3">
                        <p className="text-sm text-text-secondary dark:text-text-secondary-dark">
                            Your directories will be stored as GitHub repositories in your account.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-text-muted dark:text-text-muted-dark text-center">
                            Required to create directories
                        </p>
                    </div>
                )}
            </div>
