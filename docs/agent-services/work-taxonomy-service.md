---
id: work-taxonomy-service
title: 'WorkTaxonomyService Deep Dive'
sidebar_label: 'Work Taxonomy'
sidebar_position: 14
---
...
- [Work Ownership](/agent-services/work-ownership-service) -- provides authorization for all taxonomy operations
- [Work Generation](/agent-services/work-generation) -- uses taxonomy during content generation
- [Import System](/agent-services/import-system) -- creates initial taxonomy during work imports
