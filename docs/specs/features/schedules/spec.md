...
- Scheduled Updates (Work schedules): [scheduled-updates/](../scheduled-updates/spec.md)
- Item source-validation: [item-source-validation/](../item-source-validation/spec.md)
- Data-repo instant sync: [data-repo-instant-sync/](../data-repo-instant-sync/spec.md)
- Missions → Ideas → Works: [missions-ideas-works/](../missions-ideas-works/spec.md)
- Task tracking (recurring tasks): [task-tracking/](../task-tracking/spec.md)
- Agents (heartbeats): [agents/](../agents/spec.md)
