# Task Breakdown: Directory Members
...
- [x] T1. `DirectoryMembership` entity + migration.

## Phase 2 — Service

- [x] T2. `DirectoryMembersService` with CRUD + leave.
- [x] T3. `DirectoryOwnershipService.ensureCanRead / ensureCanEdit /
...
- [x] T12. User-facing doc `docs/features/directory-members.md`.
