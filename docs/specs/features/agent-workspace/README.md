...
| "What needs _me_?"                               | Escalations and approvals live in separate places              | A single decision queue that unblocks the work when answered |
...
- **A Mission is a source of Tasks**, alongside schedules, triggers, agents and people. It belongs
  on the board as a _filter_ and as a _provenance chip on a card_, never as the card itself.
...
| [AW-14](./AW-14-whats-new/)          | What's new — in-product changelog                     | _new (small)_                          | S   | —           |
...
| [AW-25](./AW-25-help-center/)        | Help centre in product                                | _new (small)_                          | S   | AW-01       |
...
10. **Migration timestamps come from the epic's reserved block.** TypeORM orders migrations in
    ...
    `1791` + _two-digit epic number_ + _two-digit slot_ + `00000`:
