...
_Delivers spec FR-1…FR-32 and FR-51…FR-62: the shelf, tags, the off switch, readiness badges,
the requirements enumeration, the detail panels, and the hourly sweep. No repair, no capture._
...
_Delivers spec FR-33…FR-40: one-click repair, delegated repair as a Task, the
single-open-repair guard and the permission-denied variant._
...
_Delivers spec FR-41…FR-50: drafting a Skill from a completed run, the review state, and
accept/discard with inline attach._
