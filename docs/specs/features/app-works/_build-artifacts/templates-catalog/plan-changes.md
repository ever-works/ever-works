...
`APW-01/spec.md:400`, `:465`) and what 84 lines of the plan mean by it. Only the *repository* changes. See
...
repository"). The mechanical sweep of the *epics* is C-6.6.
...
> 4. **Blueprint repository naming** — *Answered (owner, 2026-09-17): the collision is the design.* One
...
> 3. *(the old 3–6 renumber unchanged)*
...
**Proposed:** default **`ever-works/templates`**. The variable *name* stays (it is the Apps catalog's reader,
