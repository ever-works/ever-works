...
| `unknown`                | Class and attestation used when detection finds nothing it can classify. Must not be `green`. An `unknown` classification is never eligible for Ever Works Apps (no catalog entry can carry an agreement for it).                                                                                                                                                                      |
| Size                     | File ≤ 256 KiB.                                                                                                                                                                                                                                                                                                                                                                        |
...
are the union across every operand that decided the class.
