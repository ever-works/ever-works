...
The Markdown Generator creates and maintains the **markdown repository** for each work - a GitHub repository containing the README.md and individual item detail pages. It transforms structured item data into human-readable markdown format.
...
This PR updates the work README with the latest items.
...
2. `Work.readmeConfig` (header/footer customization)
