...
- [x] T1. `WorkGenerationService.createWork(method, dto, user)`
...
- [x] T8. New Work page with method picker.
...
- [x] T13. `ever-works work create` command.
...
- [x] T17. User-facing doc `docs/features/creating-a-work.md`.
