# Task Breakdown: Directory Import
...
- [x] T7. `POST /api/directories/import/preview`.
- [x] T8. `POST /api/directories/import`.
- [x] T9. e2e tests.

## Phase 4 — Web / CLI

- [x] T10. Import wizard UI.
- [x] T11. CLI `directory import` command.
...
- [x] T13. User-facing doc `docs/features/directory-import.md`.
