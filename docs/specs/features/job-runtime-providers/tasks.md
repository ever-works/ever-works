...
T1 + T2 ✅ Done in [#1354](https://github.com/ever-works/ever-works/pull/1354) (cascaded [#1360](https://github.com/ever-works/ever-works/pull/1360) -> [#1362](https://github.com/ever-works/ever-works/pull/1362)). T3 ✅ Done in [#1369](https://github.com/ever-works/ever-works/pull/1369). T5 ✅ Done in [#1368](https://github.com/ever-works/ever-works/pull/1368). T6 ✅ Done in [#1370](https://github.com/ever-works/ever-works/pull/1370). T4 ✅ Done in PR-PLACEHOLDER-T4. Phase 0 complete — only EW-686 P1 (re-house Trigger.dev as the `trigger` provider, plus wiring `buildJobRuntimeProviders()` into `TasksModule`) remains.
