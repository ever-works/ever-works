...
| Simple Tier         | _(not explicitly overridden, uses default)_ |
| Medium Tier         | _(not explicitly overridden, uses default)_ |
| Complex Tier        | _(not explicitly overridden, uses default)_ |
