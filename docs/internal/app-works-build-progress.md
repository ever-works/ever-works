...
| APW-05 builds                 | ready | 9 (of 99)            | 9            | 90           | the data layer (`6ae8c678f`), **T7–T10 the build plugin** (`2606d90d7`) and **T41 the `checks` matrix job** (`ed2476826`) landed; T13+ (the watch job) and T42 are next                                                                                                            |
