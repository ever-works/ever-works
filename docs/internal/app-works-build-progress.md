...
| C4  | `apps/web/src/lib/utils/plugin-category-icons.ts`                            | `CAPABILITY_LABELS` is a non-exhaustive `Record<string, string>` that omits `build`, `app-dependency` **and now** `identity-provider`, so those fall back to a humanised label; `HIDDEN_CAPABILITIES` and `CATEGORY_DISPLAY_ORDER` are likewise non-exhaustive. Deliberate (T4 followed precedent) but worth a decision.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | cosmetic, no gate covers it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
