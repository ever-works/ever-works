...
| D8  | `APW-13/plan.md:819` + `:718`                                        | Both name `apps/web/e2e/helpers/__tests__/canary-sink.unit.spec.ts`; **T11's own Test line** names only `app-works-evidence.unit.spec.ts`. The six FR-61 canary cases are green inside the latter and move verbatim if the plan row is to be satisfied.                                                                                                                           | APW-13            |
...
| D12 | `APW-12/tasks.md` T33 + `docs/plugin-system/plugin-categories.md:51` | T33 owes the built-in-plugins doc row, and the categories doc's "Nineteen of the twenty-four carry at least one shipped plugin" goes stale the moment `identity` joins.                                                                                                                                                                                                           | APW-12 T33        |
